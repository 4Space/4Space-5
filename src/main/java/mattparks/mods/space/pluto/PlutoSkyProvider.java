...
public class PlutoSkyProvider extends IRenderHandler {
	private static final ResourceLocation charonTexture = new ResourceLocation(PlutoCore.instance.prefixTexture + "textures/gui/celestialbodies/charon.png");
	...
	public PlutoSkyProvider(IGalacticraftWorldProvider asteroidsProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		PlutoWorldProvider gcProvider = null;

		if (world.provider instanceof PlutoWorldProvider) {
			gcProvider = (PlutoWorldProvider) world.provider;
		}
		...
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(PlutoSkyProvider.charonTexture);
