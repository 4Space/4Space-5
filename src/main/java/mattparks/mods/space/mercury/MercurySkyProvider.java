...
public class MercurySkyProvider extends IRenderHandler {
	...
	public MercurySkyProvider(IGalacticraftWorldProvider provider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		MercuryWorldProvider gcProvider = null;

		if (world.provider instanceof MercuryWorldProvider) {
			gcProvider = (MercuryWorldProvider) world.provider;
		}
		...
		var23.addVertexWithUV(-var12, 125.0D, -var12, 0.0D, 0.0D);
		var23.addVertexWithUV(var12, 125.0D, -var12, 1.0D, 0.0D);
		var23.addVertexWithUV(var12, 125.0D, var12, 1.0D, 1.0D);
		var23.addVertexWithUV(-var12, 125.0D, var12, 0.0D, 1.0D);
		var23.draw();
