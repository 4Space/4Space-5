...
import mattparks.mods.space.core.blocks.ItemBlockUtil;
...
public class BlockCaravanModule extends Block implements IPartialSealableBlock {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(MercuryCore.instance.prefixTexture + name);
	}
	...
	private void breakBlocks(World par1World, int x, int y, int z, boolean item) {
		...
		if (par1World.blockExists(x, y, z)) {
			if (block == MercuryBlocks.caravanDummy || block == GCBlocks.glowstoneTorch || block == Blocks.lit_furnace || block == Blocks.furnace || block == Blocks.chest || block == Blocks.crafting_table || block == Blocks.wooden_door || block == GCBlocks.tinStairs2) {
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
		...
		this.setBlocks(par1World, par2, par3, par4 - 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 1, par3, par4 - 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 1, par3, par4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 1, par3, par4 + 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3, par4 + 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 1, par3, par4 + 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 1, par3, par4, true, MercuryBlocks.caravanDummy);
		...
		this.setBlocks(par1World, par2 - 1, par3, par4 + 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3, par4 + 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 1, par3, par4 + 2, true, MercuryBlocks.caravanDummy);

		this.setBlocks(par1World, par2 - 1, par3, par4 + 3, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3, par4 + 3, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 1, par3, par4 + 3, true, MercuryBlocks.caravanDummy);

		this.setBlocks(par1World, par2 - 1, par3, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 1, par3, par4 + 4, true, MercuryBlocks.caravanDummy);

		this.setBlocks(par1World, par2 + 2, par3, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3, par4 + 3, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3, par4 + 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3, par4 + 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3, par4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3, par4 - 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3, par4 - 2, true, MercuryBlocks.caravanDummy);
		...
		this.setBlocks(par1World, par2 - 1, par3 + 1, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 1, par3 + 1, par4 + 4, true, MercuryBlocks.caravanDummy);

		this.setBlocks(par1World, par2 + 2, par3 + 1, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 1, par4 + 3, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 1, par4 + 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 1, par4 + 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 1, par4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 1, par4 - 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 1, par4 - 2, true, MercuryBlocks.caravanDummy);

		this.setBlocks(par1World, par2 + 1, par3 + 1, par4 - 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3 + 1, par4 - 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 1, par3 + 1, par4 - 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 2, par3 + 1, par4 - 2, true, MercuryBlocks.caravanDummy);
		...
		this.setBlocks(par1World, par2 - 1, par3 + 2, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 1, par3 + 2, par4 + 4, true, MercuryBlocks.caravanDummy);

		this.setBlocks(par1World, par2, par3, par4 + 5, true, GCBlocks.tinStairs2, 3);

		this.setBlocks(par1World, par2 + 2, par3 + 2, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 2, par4 + 3, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 2, par4 + 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 2, par4 + 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 2, par4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 2, par4 - 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 2, par4 - 2, true, MercuryBlocks.caravanDummy);

		this.setBlocks(par1World, par2 - 2, par3 + 2, par4 + 2, true, MercuryBlocks.caravanDummy);

		this.setBlocks(par1World, par2 + 1, par3 + 2, par4 - 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3 + 2, par4 - 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 1, par3 + 2, par4 - 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 2, par3 + 2, par4 - 2, true, MercuryBlocks.caravanDummy);
		...
		this.setBlocks(par1World, par2 - 1, par3 + 3, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3 + 3, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 1, par3 + 3, par4 + 4, true, MercuryBlocks.caravanDummy);

		this.setBlocks(par1World, par2 + 2, par3 + 3, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 3, par4 + 3, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 3, par4 + 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 3, par4 + 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 3, par4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 3, par4 - 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 + 2, par3 + 3, par4 - 2, true, MercuryBlocks.caravanDummy);

		this.setBlocks(par1World, par2 + 1, par3 + 3, par4 - 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3 + 3, par4 - 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 1, par3 + 3, par4 - 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 2, par3 + 3, par4 - 2, true, MercuryBlocks.caravanDummy);
		...
		this.setBlocks(par1World, par2, par3 + 4, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3 + 4, par4 - 2, true, MercuryBlocks.caravanDummy);

		this.setBlocks(par1World, par2, par3 + 5, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3 + 5, par4 + 3, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3 + 5, par4 + 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3 + 5, par4 + 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3 + 5, par4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3 + 5, par4 - 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2, par3 + 5, par4 - 2, true, MercuryBlocks.caravanDummy);

		this.setBlocks(par1World, par2 - 1, par3 + 4, par4 + 4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 1, par3 + 4, par4 + 3, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 1, par3 + 4, par4 + 2, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 1, par3 + 4, par4 + 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 1, par3 + 4, par4, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 1, par3 + 4, par4 - 1, true, MercuryBlocks.caravanDummy);
		this.setBlocks(par1World, par2 - 1, par3 + 4, par4 - 2, true, MercuryBlocks.caravanDummy);
