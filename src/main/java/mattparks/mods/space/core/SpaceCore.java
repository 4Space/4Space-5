...
import mattparks.mods.space.core.builder.ICoreModule;
import mattparks.mods.space.core.builder.celestials.ICoreCelestial;
import mattparks.mods.space.core.builder.celestials.ICoreMoon;
...
import mattparks.mods.space.core.utils.SpaceCreativeTab;
import mattparks.mods.space.core.utils.SpaceLog;
import mattparks.mods.space.core.utils.SpacePair;
import mattparks.mods.space.core.utils.SpaceVersionCheck;
...
public class SpaceCore {
    ...
    public void preInit(FMLPreInitializationEvent event) {
    	...
    	modulesList.add(new MercuryCore(event));
    	modulesList.add(new PlutoCore(event));
	...
	private void initMusic() {
		for (ICoreModule module : modulesList) {
			if (module instanceof ICoreCelestial) {
				...
				String musicJSON = celestial.getMusicJSON();
				
				if (musicJSON != null) {
					ClientProxy.MUSIC_HANDLER_SPACE.loadMusicType(celestial, musicJSON);
				}
			}
		}
	}
