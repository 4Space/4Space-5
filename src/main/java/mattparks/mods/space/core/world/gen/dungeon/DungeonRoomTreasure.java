...
public class DungeonRoomTreasure extends DungeonRoom {
	int sizeX;
	int sizeY;
	int sizeZ;
	...
	public DungeonRoomTreasure(DungeonMapGen dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir) {
	...
	protected DungeonRoom makeRoom(DungeonMapGen dungeon, int x, int y, int z, ForgeDirection dir) {
		return new DungeonRoomTreasure(dungeon, x, y, z, dir);
	}
