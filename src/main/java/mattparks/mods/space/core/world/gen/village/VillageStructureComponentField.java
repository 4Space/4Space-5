...
public class VillageStructureComponentField extends VillageStructureComponent {
	private int averageGroundLevel = -1;

	public VillageStructureComponentField() {
	}

	public VillageStructureComponentField(VillageStructureComponentStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
