...
public class VillageStructureComponentWell extends VillageStructureComponent {
	private int averageGroundLevel = -1;

	public VillageStructureComponentWell() {
	}

	public VillageStructureComponentWell(VillageStructureComponentStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, int par4, int par5) {
