...
public class PitStructureComponentStairway extends StructureComponentGC {
	protected PitStructureComponentStairway(PitStructureComponentRoom origRoom, int type, Random rand, int x, int y, int z) {
		super(type);
