...
public class DungeonRoomBoss extends DungeonRoom {
	public int sizeX;
	public int sizeY;
	public int sizeZ;
	Random rand;
	...
	public DungeonRoomBoss(DungeonMapGen dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir) {
	...
	protected DungeonRoom makeRoom(DungeonMapGen dungeon, int x, int y, int z, ForgeDirection dir) {
		return new DungeonRoomBoss(dungeon, x, y, z, dir);
	}
	...
	protected void handleTileEntities(Random rand) {
		...
		if (tile == null || !(tile instanceof TileEntityDungeonSpawnerMars)) {
			TileEntityDungeonSpawnerMars spawner = new TileEntityDungeonSpawnerMars();
		...
		} else if (tile instanceof TileEntityDungeonSpawnerMars) {
			((TileEntityDungeonSpawnerMars) tile).setRoom(new Vector3(this.posX, this.posY, this.posZ), new Vector3(this.sizeX, this.sizeY, this.sizeZ));
		}
	}
