...
public class VillageStructureComponentHouse extends VillageStructureComponent {
	private int averageGroundLevel = -1;

	public VillageStructureComponentHouse() {
	}

	public VillageStructureComponentHouse(VillageStructureComponentStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
