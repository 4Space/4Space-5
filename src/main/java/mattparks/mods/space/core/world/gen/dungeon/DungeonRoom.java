...
public abstract class DungeonRoom {
	public final DungeonMapGen dungeonInstance;
	...
	public DungeonRoom(DungeonMapGen dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir) {
	...
	protected abstract DungeonRoom makeRoom(DungeonMapGen dungeon, int x, int y, int z, ForgeDirection dir);

	protected abstract void handleTileEntities(Random rand);

	public static DungeonRoom makeRoom(DungeonMapGen dungeon, Random rand, int x, int y, int z, ForgeDirection dir) {
		return dungeon.otherRooms.get(rand.nextInt(dungeon.otherRooms.size())).makeRoom(dungeon, x, y, z, dir);
	}

	public static DungeonRoom makeBossRoom(DungeonMapGen dungeon, Random rand, int x, int y, int z, ForgeDirection dir) {
		return dungeon.bossRooms.get(rand.nextInt(dungeon.bossRooms.size())).makeRoom(dungeon, x, y, z, dir);
	}

	public static DungeonRoom makeTreasureRoom(DungeonMapGen dungeon, Random rand, int x, int y, int z, ForgeDirection dir) {
