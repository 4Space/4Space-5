...
public abstract class VillageStructureComponent extends StructureComponent {
	private int villagersSpawned;
	protected VillageStructureComponentStartPiece startPiece;

	public VillageStructureComponent() {
	}

	protected VillageStructureComponent(VillageStructureComponentStartPiece par1ComponentVillageStartPiece, int par2) {
		super(par2);
