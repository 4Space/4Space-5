...
public class VillageStructureComponentField2 extends VillageStructureComponent {
	...
	public VillageStructureComponentField2() {
	}

	public VillageStructureComponentField2(VillageStructureComponentStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
