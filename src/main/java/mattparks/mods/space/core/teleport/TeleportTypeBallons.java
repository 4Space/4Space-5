package mattparks.mods.space.core.teleport;
...
/**
 * A teleportation type that spawns the player inside a Galacticraft balloon lander.
 */
public class TeleportTypeBallons implements ITeleportType {
	@Override
